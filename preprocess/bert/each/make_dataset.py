...
def load_infovec():
    with open('/mnt/LSTA5/data/tanaka/lang-learn/coco/vector/bert/train_semantic_scoring/each_wn05/train2017_bertinfovec.pkl', 'rb') as f:
        train_infovec = pickle.load(f) 
    with open('/mnt/LSTA5/data/tanaka/lang-learn/coco/vector/bert/val_semantic_scoring/each_wn05/val2017_bertinfovec.pkl', 'rb') as f:
...
def main():
    ...
    with open('/mnt/LSTA5/data/tanaka/lang-learn/coco/vector/bert/train_semantic_scoring/each_wn05/imagedata.pkl', 'wb') as f:
        pickle.dump(imagedata, f, protocol=4)
    with open('/mnt/LSTA5/data/tanaka/lang-learn/coco/vector/bert/train_semantic_scoring/each_wn05/keydata.pkl', 'wb') as f:
        pickle.dump(keydata, f, protocol=4) 
    with open('/mnt/LSTA5/data/tanaka/lang-learn/coco/vector/bert/train_semantic_scoring/each_wn05/ansdata.pkl', 'wb') as f:
        pickle.dump(ansdata, f, protocol=4) 
    with open('/mnt/LSTA5/data/tanaka/lang-learn/coco/vector/bert/train_semantic_scoring/each_wn05/labeldata.pkl', 'wb') as f:
    ...
    with open('/mnt/LSTA5/data/tanaka/lang-learn/coco/vector/bert/val_semantic_scoring/each_wn05/imagedata.pkl', 'wb') as f:
        pickle.dump(imagedata, f, protocol=4)
    with open('/mnt/LSTA5/data/tanaka/lang-learn/coco/vector/bert/val_semantic_scoring/each_wn05/keydata.pkl', 'wb') as f:
        pickle.dump(keydata, f, protocol=4) 
    with open('/mnt/LSTA5/data/tanaka/lang-learn/coco/vector/bert/val_semantic_scoring/each_wn05/ansdata.pkl', 'wb') as f:
        pickle.dump(ansdata, f, protocol=4) 
    with open('/mnt/LSTA5/data/tanaka/lang-learn/coco/vector/bert/val_semantic_scoring/each_wn05/labeldata.pkl', 'wb') as f:
        pickle.dump(labeldata, f, protocol=4) 
    print("完了")
